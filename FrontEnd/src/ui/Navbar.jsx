...
function Navbar({ setPopupVisible, setPreviewToggle }) {
  return (
    <>
      <div className=" bg-white fixed bottom-0 left-0 lg:static w-[100%] lg:w-[400px] flex lg:items-center justify-between  px-2  py-3 lg:py-0 lg:pb-3 md:justify-between md:px-[30px]  md:pt-[30px] ">
        <button
